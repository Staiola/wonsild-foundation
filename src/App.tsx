...
export default function App() {
  ...
  return <div className="ef-system"><a className="skip-link" href="#main-content">Skip to content</a><header className="site-header"><a className="wordmark" href="./" aria-label="WonsildFoundation home">Wonsild<span>Foundation</span><span className="wordmark-dot">.</span></a><SiteLinks style={style} showComponents={false}/><div className="header-tools"><div className="style-picker"><Label htmlFor="style-picker">Style</Label><Select value={style} onValueChange={changeStyle}><SelectTrigger id="style-picker"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="editorial">Editorial</SelectItem><SelectItem value="stone">Stone</SelectItem></SelectContent></Select></div><ThemeToggle/></div></header><Tabs value={view} onValueChange={changeView} className="site-tabs"><nav className="site-nav" aria-label="Reference pages"><TabsList><TabsTrigger value="foundation">Foundations</TabsTrigger><TabsTrigger value="components">Components</TabsTrigger><TabsTrigger value="workspace">Example app</TabsTrigger></TabsList><a className="version version-link" href={`${config.repository}/blob/main/CHANGELOG.md`} aria-label={`Version ${VERSION} — changelog`}>v{VERSION} ↗</a></nav><main id="main-content" className="site-main"><TabsContent value="foundation"><FoundationReference style={style}/></TabsContent><TabsContent value="components"><ComponentsReference style={style}/></TabsContent><TabsContent value="workspace"><WorkspaceExample/></TabsContent></main></Tabs><footer className="site-footer"><a href="https://staiola.studio/">By Staiola.Studio</a><a href={`./landing.html?style=${style}`}>About WonsildFoundation</a><a href="./checks.html">Component stress checks</a><a href={`${config.repository}/blob/main/CHANGELOG.md`}>Changelog</a><a href={config.repository}>GitHub ↗</a></footer></div>;
}
